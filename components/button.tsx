...
const Button = ({ type, size, text, textType, onPress }: ButtonProps) => {
    ...
    const fontWeight = textType === "solid" ? "font-bold" : "font-normal"

    return (
        <TouchableOpacity
            onPress={onPress}
            className={`p-2 m-1 border ${borderColour} rounded-3xl flex justify-center items-center ${backgroundColour} ${width} ${height}`}
        >
